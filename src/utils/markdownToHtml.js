...
<script defer src="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/contrib/auto-render.min.js"
  onload="renderMathInElement(document.body,{delimiters:[{left:'$$',right:'$$',display:true},{left:'$',right:'$',display:false}],throwOnError:false});"></script>` : '';
    ...
    return `<!DOCTYPE html>
<html><head>
<meta charset="utf-8"><title>OCR Results — onlineocrfree</title>
...
<div style="text-align:center;margin-bottom:24px;padding-bottom:12px;border-bottom:2px solid #e5e7eb;">
  <h1 style="margin:0 0 4px;font-size:20px;font-weight:700;color:#111827;border:none;padding:0;">onlineocrfree</h1>
  <p style="margin:0;font-size:12px;color:#6b7280;">Extracted with <a href="https://onlineocrfree.qzz.io" style="color:#2563eb;text-decoration:none;">onlineocrfree.qzz.io</a></p>
</div>
${sections}
<div style="text-align:center;margin-top:32px;padding-top:12px;border-top:1px solid #e5e7eb;font-size:11px;color:#9ca3af;">
  Generated by <a href="https://onlineocrfree.qzz.io" style="color:#9ca3af;text-decoration:none;">onlineocrfree.qzz.io</a>
</div>
</body></html>`;
};
